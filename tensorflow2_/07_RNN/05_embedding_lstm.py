...
"""
    分别通过
        单层单向 LSTM  accuracy: 0.5120 -> rnn accuracy: 0.5099
        双向多层 LSTM  accuracy: 0.8184 -> rnn accuracy: 0.6800
        双向单层 LSTM  accuracy: 0.7948 -> rnn accuracy: 0.7704
...
plot_learning_curves(history_single_lstm, 'loss', 30, 0, 2.5)

plot_learning_curves(history, 'accuracy', 30, 0, 1)
plot_learning_curves(history, 'loss', 30, 0, 2.5)

plot_learning_curves(bi_lstm_history, 'accuracy', 30, 0, 1)
plot_learning_curves(bi_lstm_history, 'loss', 30, 0, 2.5)

print("单向单层 lstm")
single_lstm_model.evaluate(
